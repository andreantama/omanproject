		...
		<tbody>
			...
			<tr valign="middle" align="center">
				...
				<?php
					...
					$nilai_uas = $this->guru_rekapnilai->tampilData('tbl_nilai_uas','*', array('NO_GURU' => $this->session->userdata('user_access_id'),'ID_TAHUN_PEL' => $detail_semester, 'NO_SISWA' => $rekap_nilai->NO_SISWA, 'ID_MAPEL' => $id_mapel), TRUE);
