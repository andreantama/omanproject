...
<div class="container_list" id="paging_container1">
	...
	?>
			<li class="news-item">
				<h1 class="title"><a href="<?= base_url('homepage_berita/detailBerita/'.$berita->ID_PENGUMUMAN) ?>"><?= $berita->JUDUL_PENGUMUMAN ?></a></h1>
				...
				<div class="textarea">
						...
						<a class="content-readmore" href="<?= base_url('homepage_berita/detailBerita/'.$berita->ID_PENGUMUMAN) ?>">
								Read more...			
					</a>
				</div>
			</li>
