		...
		<div class="bg-container">
			<div class="bg">
				...
				<div class="container-1">
					...
					<h2>Informasi Terkini Dari SMPIT</h2>
<div class="container_list" id="paging_container1">
	...
	?>
			<li class="news-item">
				<h1 class="title"><a href="<?= base_url('homepage_smpit/detail/'.$berita->ID_PENGUMUMAN) ?>"><?= $berita->JUDUL_PENGUMUMAN ?></a></h1>
				...
				<div class="textarea">
						...
						<a class="content-readmore" href="<?= base_url('homepage_smpit/detail/'.$berita->ID_PENGUMUMAN) ?>">
								Read more...			
					</a>
				</div>
			</li>
