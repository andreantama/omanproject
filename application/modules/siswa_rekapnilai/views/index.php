		...
		<div class="panel panel-default">
			<div class="panel-body">
	            ...
	            <div class="form-group">
					...
					<select id="id_mapel" class="form-control">
						 <?php
			                 $a = 0;foreach($data_mapel as $data_mapel):
			             ?>
			             <?php if($a != 0): ?>
	            ...
	            <button type="button" class="btn btn-primary" id="filter_kelasnya">Rekap Nilai</button>
			</div>
		</div>
	</div>
	<div class="col-md-12">
...
<script>
   $(document).ready(function () {
   		$('#filter_kelasnya').click(function(){
   			...
   			$.ajax({
				method : "POST",
				url : '<?= base_url("siswa_rekapnilai/filterKelas") ?>',
