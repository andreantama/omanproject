			...
			<div style="overflow: auto;margin-bottom: 10px">
				...
				<table class="table table-bordered" style="width: 2200px">
					...
					<?php
						...
						$detail_absen = $this->siswa_rekapabsensi->tampilData('tbl_absen','*', array('NO_SISWA' => $data_siswa->NO_SISWA, 'ID_KELAS' => $id_kelas, 'ID_TAHUN_PEL' => $detail_semester, 'MONTH' => (int)$bulan), TRUE);
				...
				<a href="<?= base_url('gurubp_inputabsensi') ?>" class="btn btn-info">Kembali</a>
