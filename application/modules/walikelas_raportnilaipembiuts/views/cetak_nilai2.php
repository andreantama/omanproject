...
<body class="A4" onload="window.print()" style="padding-top: 20px;padding-left: 20px;padding-right: 20px;padding-bottom: 20px;">
  ...
  <section class="sheet padding-10mm">
	...
	<table style="border-collapse: collapse" border="1" width="100%" cellpadding="4">
			...
			<td align="center">
				...
				<?php
					...
					foreach($rekap_nilai as $wudu){
						...
						$wudu = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','WUDHU',array('NO_SISWA' => $wudu->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
			...
			<td align="center">
				...
				<?php
					...
					foreach($rekap_nilai as $sholat){
						...
						$sholat = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','SHOLAT',array('NO_SISWA' => $sholat->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
			...
			<td align="center">
				...
				<?php
					...
					foreach($rekap_nilai as $tahsin){
						...
						$tahsin = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','TAHSIN',array('NO_SISWA' => $tahsin->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
		...
		<?php
			...
			$cek_surah_1 = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','NAMA_SURAH, TAHFIDZH',array('NO_SISWA' => $detail_siswa->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
			...
			<td align="center">
				...
				<?php
					...
					foreach($rekap_nilai as $tahfidzh){
						...
						$tahfidzh = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','TAHFIDZH',array('NO_SISWA' => $tahfidzh->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
		...
		<?php
			...
			$cek_surah_2 = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','NAMA_SURAH_2, TAHFIDZH_2',array('NO_SISWA' => $detail_siswa->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
			...
			<td align="center">
				...
				<?php
					...
					foreach($rekap_nilai as $tahfidzh_2){
						...
						$tahfidzh_2 = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','TAHFIDZH_2',array('NO_SISWA' => $tahfidzh_2->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
			...
			<td align="center">
				...
				<?php
					...
					foreach($rekap_nilai as $surat_pendek){
						...
						$surat_pendek = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','SURAT_PENDEK',array('NO_SISWA' => $surat_pendek->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
			...
			<td align="center">
				...
				<?php
					...
					foreach($rekap_nilai as $hadits){
						...
						$hadits = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','HADITS',array('NO_SISWA' => $hadits->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
			...
			<td align="center">
				...
				<?php
					...
					foreach($rekap_nilai as $doa){
						...
						$doa = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','DOA',array('NO_SISWA' => $doa->NO_SISWA, 'ID_TAHUN_PEL' => $semester_aktifnya), TRUE);
		...
		<!--<tr>
			...
			<?php $peringkat = $this->walikelas_raportnilaipembiuts->tampilData('tbl_nilai_peringkat','PERINGKAT', array('NO_SISWA' => $detail_siswa->NO_SISWA, 'ID_KELAS' => $detail_kelas->ID_KELAS, 'ID_TAHUN_PEL' => $semester_aktif->ID_TAHUN_PEL), TRUE); ?>
	...
	<table style="border-collapse: collapse;margin-bottom: 25px" border="1" width="100%" cellpadding="4">
			...
			<td style="padding-left: 380px;">
				<table style="border-collapse: collapse;margin-left: 60px">
					...
					<tr>
						...
						<td>:</td>
						<td><?= $this->jariprom_tools->tglIndo( (isset($_GET['print-date']) ? date('Y-m-d', strtotime($_GET['print-date'])) : date('Y-m-d')) ) ?></td>
					</tr>
				</table>
			</td>
