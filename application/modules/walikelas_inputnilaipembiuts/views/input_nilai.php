<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<form action="<?= base_url('walikelas_inputnilaipembiuts/inputNilaiSubmit') ?>" method="post">
				...
				<div class="row">
					...
					<input type="submit" class="btn btn-default" value="Terapkan Nilai"/> <a class="btn btn-info" href="<?= base_url('walikelas_inputnilaipembiuts') ?>">Kembali</a>
				</form>
			</div>
		</div>
	</div>
