<div class="row">
   ...
   <div class="col-md-12">
      ...
      <form action="<?= base_url('guru_detailakun/editGuruSubmit') ?>" method="post" enctype="multipart/form-data">
         ...
         <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
               ...
               <li><a href="#tab_5" data-toggle="tab"><i class="fa fa-print"></i> Cetak</a></li>
			...
			<div class="tab-pane" id="tab_3">
               ...
               <div class="tab-pane" id="tab_4">
				...
				<div class="tab-pane" id="tab_5">
                  ...
                  <p>Cetak Profil dengan klik tombol dibawah ini :</p>

                  <p><a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('<?= base_url('guru_detailakun/cetakGuru') ?>', '_blank', 'width=800,height=600,scrollbars=yes,status=yes,resizable=yes,screenx=0,screeny=0');">Cetak Profil</a></p>
