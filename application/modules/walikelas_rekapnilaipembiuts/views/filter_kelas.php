...
<hr/>
	<div class="form-group">
		<a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('<?= base_url('walikelas_rekapnilaipembiuts/cetakRekapNilaiPembi/'.$this->jariprom_tools->base64_encode_fix($detail_kelas->ID_KELAS).'/'.$detail_semester) ?>', '_blank', 'width=800,height=600,scrollbars=yes,status=yes,resizable=yes,screenx=0,screeny=0');">Cetak Nilai</a>
	</div>
	...
	<div style="overflow: auto">
		...
		<table class="table table-striped table-bordered" style="width: 1500px">
        	...
        	<?php
				...
				$count_all_pembi = 6;
				$detail_nilai = $this->walikelas_rekapnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','*', array('ID_TAHUN_PEL' => $detail_semester, 'NO_SISWA' => $rekap_nilai->NO_SISWA), TRUE);
			?>
			<tr valign="middle" align="center">
				...
				<?php
					$cek_surah_1 = $this->walikelas_rekapnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','NAMA_SURAH, TAHFIDZH',array('NO_SISWA' => $rekap_nilai->NO_SISWA, 'ID_TAHUN_PEL' => $detail_semester), TRUE);
				...
				<?php endif; ?>
				<?php
					$cek_surah_2 = $this->walikelas_rekapnilaipembiuts->tampilData('tbl_nilai_pembiasaan_uts','NAMA_SURAH_2, TAHFIDZH_2',array('NO_SISWA' => $rekap_nilai->NO_SISWA, 'ID_TAHUN_PEL' => $detail_semester), TRUE);
