...
<li <?php echo ($modul_active == 'master_bukti' ? "class='active'" : ""); ?>><a href="<?php echo base_url('master_bukti') ?>"><i class="fa fa-user text-aqua"></i> <span>Bukti Pembayaran</span></a></li>
